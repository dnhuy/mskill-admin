...
const AddEditExamGateSubject = ({ checkEdit, dataExamGateSubject }) => {
  ...
  return (
    <Card>
      <Form name="add-edit-exam-gate-subject" layout="vertical" onFinish={handleSubmit}>
        <Row gutter={32}>
          <Col span={24}>
            <Form.Item
              label="Tên lĩnh vực"
              name="name"
              rules={[{ required: true, message: 'Tên lĩnh vực không được để trống!' }]}
            >
        ...
        <Row gutter={8} justify="center">
          ...
          <Col>
            <Button type="primary" danger>
              <Link to="/course_filter/exam_gate_subject">Hủy</Link>
            </Button>
          </Col>
        </Row>
      </Form>
...
export default AddEditExamGateSubject;
