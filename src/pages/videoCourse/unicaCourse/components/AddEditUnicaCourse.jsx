...
const AddEditUnicaCourse = ({ checkEdit, dataUnicaCourse }) => {
  let descriptionRef;
  ...
  return (
    <Card>
      <Form name="add-edit-unica-course" layout="vertical" onFinish={handleSubmit}>
        <Row gutter={32}>
          <Col xs={24} md={16}>
            <Form.Item
              label="Tên khóa học"
        ...
        <Row gutter={8} justify="center">
          ...
          <Col>
            <Button type="primary" danger>
              <Link to="/video_course/unica_course">Hủy</Link>
            </Button>
          </Col>
        </Row>
      </Form>
...
export default AddEditUnicaCourse;
