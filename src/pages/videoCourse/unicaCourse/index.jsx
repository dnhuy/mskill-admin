...
const UnicaCourse = () => {
  ...
  const columns = [
    ...
    {
      title: 'SL mã kích hoạt chưa sử dụng',
      render: (text, record) => {
        return null;
      },
      hideInSearch: true,
        ...
        <ProTable
          ...
          toolBarRender={() => [
            <Button key="add" type="primary">
              <Link to="/video_course/unica_course/add_unica_course">Thêm mới</Link>
            </Button>,
            <Button key="active_code">Mã kích hoạt</Button>,
          ]}
        />
      </IntlProvider>
    </PageContainer>
